...
public class Control {
	...
	public static int insertConfigSource(Connection conn, String sourceName, String sourceUrl,
										 ...
										 String transformProcedure, String proc_load_warehouse, String aggregateProcedure, String aggregateTable,
		...
		try {
			String sql = "INSERT INTO config_source "
					...
					+ "destination_staging, transform_procedure, proc_load_warehouse, "
			...
			//
			ps.setString(8, proc_load_warehouse);
			//
