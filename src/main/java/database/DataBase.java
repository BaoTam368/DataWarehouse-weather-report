...
public class DataBase {
	...
	public static Connection connectDB(String host, int port, String user, String pass, String name)
			throws SQLException {
		try {
			// Tạo chuỗi kết nối JDBC với thông tin host, port, tên database và các tham số
			// kết nối
			...
			EmailUtils.send("Lỗi hệ thống: không thể kết nối database: " + name, "Chi tiết lỗi: " + e.getMessage());
